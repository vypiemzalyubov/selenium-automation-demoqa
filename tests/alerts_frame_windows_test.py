...
class TestModalDialogsPage:
    ...
    @pytest.mark.parametrize('method', ['button', 'cross', 'overlay'])
    def test_small_modal_dialogs(self, method):
        ...
        assert (
            'This is a small modal' in body_small_text
    ...
    def test_large_modal_dialogs(self, method):
        ...
        assert 'Lorem Ipsum' in body_large_text, 'Small modal body does not content "Lorem Ipsum"'
