...
class TestLinksPage:
    ...
    @pytest.mark.parametrize('locator_name', ['SIMPLE_LINK', 'DYNAMIC_LINK'])
    ...
    def test_check_broken_link(self, locator_name):
        ...
        assert (
            expected_word in response_text
...
class TestUploadAndDownload:
    ...
    def test_upload_file(self):
        ...
        assert file_name == uploaded_text, 'The file has not been uploaded'
    ...
    def test_download_file(self):
        ...
        assert check_file_exists is True, 'The file has not been downloaded'
